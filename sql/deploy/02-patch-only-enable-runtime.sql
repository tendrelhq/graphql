-- Deploy graphql:02-patch-only-enable-runtime to pg
--
-- This patch disables the other tiny tendies because, for some reason, calling
-- those procedures in CI raises a unique constraint violation :/
-- Don't ask me why.
