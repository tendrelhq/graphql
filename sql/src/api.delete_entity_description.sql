...
-- Type: FUNCTION ; Name: api.delete_entity_description(uuid,uuid); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION api.delete_entity_description(uuid,uuid) TO bombadil WITH GRANT OPTION;
