...
-- Type: FUNCTION ; Name: api.delete_entity_field(uuid,uuid); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION api.delete_entity_field(uuid,uuid) TO bombadil WITH GRANT OPTION;
