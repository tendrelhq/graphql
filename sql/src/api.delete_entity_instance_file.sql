...
-- Type: FUNCTION ; Name: api.delete_entity_instance_file(uuid,uuid); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION api.delete_entity_instance_file(uuid,uuid) TO bombadil WITH GRANT OPTION;
