...
-- Type: FUNCTION ; Name: api.token(api.grant_type,text,api.token_type,text,text); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION api.token(api.grant_type,text,api.token_type,text,text) TO bombadil WITH GRANT OPTION;
