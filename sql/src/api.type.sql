...
-- Type: FUNCTION ; Name: api.type(api.z_20250409_template_field); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION api.type(api.z_20250409_template_field) TO bombadil WITH GRANT OPTION;
