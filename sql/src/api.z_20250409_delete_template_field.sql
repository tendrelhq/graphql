...
-- Type: FUNCTION ; Name: api.z_20250409_delete_template_field(); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION api.z_20250409_delete_template_field() TO bombadil WITH GRANT OPTION;
