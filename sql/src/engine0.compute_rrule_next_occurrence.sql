...
-- Type: FUNCTION ; Name: engine0.compute_rrule_next_occurrence(text,numeric,timestamp with time zone); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION engine0.compute_rrule_next_occurrence(text,numeric,timestamp with time zone) TO bombadil WITH GRANT OPTION;
