...
-- Type: FUNCTION ; Name: engine0.eval_state_condition(jsonb); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION engine0.eval_state_condition(jsonb) TO bombadil WITH GRANT OPTION;
