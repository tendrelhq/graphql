...
-- Type: FUNCTION ; Name: engine1.delete_workresult(jsonb); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION engine1.delete_workresult(jsonb) TO bombadil WITH GRANT OPTION;
