...
-- Type: FUNCTION ; Name: engine1.delete_worktemplate(jsonb); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION engine1.delete_worktemplate(jsonb) TO bombadil WITH GRANT OPTION;
