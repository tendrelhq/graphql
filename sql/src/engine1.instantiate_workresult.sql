...
-- Type: FUNCTION ; Name: engine1.instantiate_workresult(jsonb); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION engine1.instantiate_workresult(jsonb) TO bombadil WITH GRANT OPTION;
