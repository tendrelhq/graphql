...
-- Type: FUNCTION ; Name: engine1.instantiate_worktemplate(jsonb); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION engine1.instantiate_worktemplate(jsonb) TO bombadil WITH GRANT OPTION;
