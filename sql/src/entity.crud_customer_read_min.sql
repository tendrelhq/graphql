...
-- Type: FUNCTION ; Name: entity.crud_customer_read_min(uuid,uuid,uuid,boolean,boolean,boolean,boolean,uuid); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION entity.crud_customer_read_min(uuid,uuid,uuid,boolean,boolean,boolean,boolean,uuid) TO bombadil WITH GRANT OPTION;
