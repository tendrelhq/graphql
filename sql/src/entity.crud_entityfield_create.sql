...
-- Type: PROCEDURE ; Name: entity.crud_entityfield_create(uuid,uuid,uuid,integer,text,uuid,uuid,uuid,text,uuid,text,uuid,text,boolean,boolean,boolean,boolean,boolean,boolean,text,uuid,uuid,boolean,boolean,bigint); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE entity.crud_entityfield_create(uuid,uuid,uuid,integer,text,uuid,uuid,uuid,text,uuid,text,uuid,text,boolean,boolean,boolean,boolean,boolean,boolean,text,uuid,uuid,boolean,boolean,bigint) TO bombadil WITH GRANT OPTION;
