...
-- Type: FUNCTION ; Name: entity.crud_entityinstance_read_full(uuid,uuid,uuid,uuid,uuid,uuid,boolean,uuid,boolean,boolean,boolean,uuid); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION entity.crud_entityinstance_read_full(uuid,uuid,uuid,uuid,uuid,uuid,boolean,uuid,boolean,boolean,boolean,uuid) TO bombadil WITH GRANT OPTION;
