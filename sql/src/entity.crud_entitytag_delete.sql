...
-- Type: PROCEDURE ; Name: entity.crud_entitytag_delete(uuid,uuid,bigint); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE entity.crud_entitytag_delete(uuid,uuid,bigint) TO bombadil WITH GRANT OPTION;
