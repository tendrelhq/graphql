...
-- Type: FUNCTION ; Name: entity.crud_entitytag_read_full(uuid,uuid,uuid,uuid,uuid,boolean,boolean,boolean,boolean,uuid); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION entity.crud_entitytag_read_full(uuid,uuid,uuid,uuid,uuid,boolean,boolean,boolean,boolean,uuid) TO bombadil WITH GRANT OPTION;
