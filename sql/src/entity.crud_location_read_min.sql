...
-- Type: FUNCTION ; Name: entity.crud_location_read_min(uuid,uuid,uuid,uuid,boolean,uuid,boolean,boolean,boolean,uuid); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION entity.crud_location_read_min(uuid,uuid,uuid,uuid,boolean,uuid,boolean,boolean,boolean,uuid) TO bombadil WITH GRANT OPTION;
