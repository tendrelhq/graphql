...
-- Type: PROCEDURE ; Name: entity.enable_pinpoint(uuid,text,uuid,text,uuid,text,text,bigint); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE entity.enable_pinpoint(uuid,text,uuid,text,uuid,text,text,bigint) TO bombadil WITH GRANT OPTION;
