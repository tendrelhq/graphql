...
-- Type: FUNCTION ; Name: entity.func_test_customer(bigint,bigint,boolean,text,text); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION entity.func_test_customer(bigint,bigint,boolean,text,text) TO bombadil WITH GRANT OPTION;
