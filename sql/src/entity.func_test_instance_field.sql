...
-- Type: FUNCTION ; Name: entity.func_test_instance_field(bigint,bigint,boolean,text,text); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION entity.func_test_instance_field(bigint,bigint,boolean,text,text) TO bombadil WITH GRANT OPTION;
