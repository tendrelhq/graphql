...
-- Type: PROCEDURE ; Name: entity.test_entity_create(boolean,bigint); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE entity.test_entity_create(boolean,bigint) TO bombadil WITH GRANT OPTION;
