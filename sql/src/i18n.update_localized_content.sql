...
-- Type: FUNCTION ; Name: i18n.update_localized_content(text,text,text); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION i18n.update_localized_content(text,text,text) TO bombadil WITH GRANT OPTION;
