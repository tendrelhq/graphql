...
-- Type: FUNCTION ; Name: legacy0.create_field_t(text,text,text,text,boolean,boolean,boolean,text,integer,text,text,text,text,bigint); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION legacy0.create_field_t(text,text,text,text,boolean,boolean,boolean,text,integer,text,text,text,text,bigint) TO bombadil WITH GRANT OPTION;
