...
-- Type: FUNCTION ; Name: legacy0.create_template_type(text,text,bigint); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION legacy0.create_template_type(text,text,bigint) TO bombadil WITH GRANT OPTION;
