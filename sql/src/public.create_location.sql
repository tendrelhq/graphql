...
-- Type: FUNCTION ; Name: create_location(text,bigint,text,text,text,text,text); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION create_location(text,bigint,text,text,text,text,text) TO bombadil WITH GRANT OPTION;
