...
-- Type: PROCEDURE ; Name: crud_checklist_create_customer(text,text,text,bigint); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE crud_checklist_create_customer(text,text,text,bigint) TO bombadil WITH GRANT OPTION;
