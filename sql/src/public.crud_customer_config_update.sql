...
-- Type: PROCEDURE ; Name: crud_customer_config_update(text,text,text,text); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE crud_customer_config_update(text,text,text,text) TO bombadil WITH GRANT OPTION;
