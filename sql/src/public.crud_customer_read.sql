...
-- Type: FUNCTION ; Name: crud_customer_read(text,text,text); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION crud_customer_read(text,text,text) TO bombadil WITH GRANT OPTION;
