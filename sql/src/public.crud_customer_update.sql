...
-- Type: PROCEDURE ; Name: crud_customer_update(text,text,text,text,text,bigint); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE crud_customer_update(text,text,text,text,text,bigint) TO bombadil WITH GRANT OPTION;
