...
-- Type: FUNCTION ; Name: crud_location_read(text,text,text,bigint,text); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION crud_location_read(text,text,text,bigint,text) TO bombadil WITH GRANT OPTION;
