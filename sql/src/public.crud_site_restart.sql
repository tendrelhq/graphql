...
-- Type: PROCEDURE ; Name: crud_site_restart(text,text,text,bigint,bigint); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE crud_site_restart(text,text,text,bigint,bigint) TO bombadil WITH GRANT OPTION;
