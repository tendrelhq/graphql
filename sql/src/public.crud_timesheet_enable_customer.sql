...
-- Type: PROCEDURE ; Name: crud_timesheet_enable_customer(text,text,bigint); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE crud_timesheet_enable_customer(text,text,bigint) TO bombadil WITH GRANT OPTION;
