...
-- Type: FUNCTION ; Name: crud_timesheet_export_list(timestamp with time zone,boolean,bigint); Owner: bombadil
...
GRANT EXECUTE ON FUNCTION crud_timesheet_export_list(timestamp with time zone,boolean,bigint) TO bombadil WITH GRANT OPTION;
