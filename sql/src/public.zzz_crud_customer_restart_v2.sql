...
-- Type: PROCEDURE ; Name: zzz_crud_customer_restart_v2(text,text,text,bigint); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE zzz_crud_customer_restart_v2(text,text,text,bigint) TO bombadil WITH GRANT OPTION;
