...
-- Type: PROCEDURE ; Name: zzz_crud_location_restart_v2(text,text,text,bigint,bigint); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE zzz_crud_location_restart_v2(text,text,text,bigint,bigint) TO bombadil WITH GRANT OPTION;
