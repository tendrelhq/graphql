...
-- Type: PROCEDURE ; Name: zzz_crud_site_update_v2(text,text,text,bigint,text,text,text,text,text,text,text,bigint); Owner: bombadil
...
GRANT EXECUTE ON PROCEDURE zzz_crud_site_update_v2(text,text,text,bigint,text,text,text,text,text,text,text,bigint) TO bombadil WITH GRANT OPTION;
