CREATE OR REPLACE PROCEDURE entity.crud_entityinstance_create(
  IN create_entityinstanceownerentityuuid uuid,
  IN create_entityinstanceentitytemplateentityuuid uuid,
  IN create_entityinstanceentitytemplateentityname text,
  IN create_entityinstanceparententityuuid uuid,
  IN create_entityinstanceecornerstoneentityuuid uuid,
  IN create_entityinstancecornerstoneorder integer,
  IN create_entityinstancetaguuid uuid,
  IN create_entityinstancetag text,
  IN create_entityinstancename text,
  IN create_entityinstancescanid text,
  IN create_entityinstancetypeuuid uuid,
  IN create_entityinstanceexternalid text,
  IN create_entityinstanceexternalsystemuuid uuid,
  IN create_entityinstancedeleted boolean,
  IN create_entityinstancedraft boolean,
  OUT create_entityinstanceentityuuid uuid,
...
if tempentitytemplateuuid notnull and tempentitytemplateisprimary = true
	then return; -- need error code
end if;

create_entityinstanceentityuuid = tempentitytemplateuuid;
...
if tempentitytemplateuuid isnull 
	and (create_entityinstanceentitytemplateentityname isNull
		or coalesce(create_entityinstanceentitytemplateentityname,'')= '')
	then return; -- need error code
end if;
...
if tempentitytemplateuuid isNull and create_entityinstanceentitytemplateentityname notNull 
...
If array_length(tempentitytagcustagentityuuid, 1) = 0 and create_entityinstancetag notNull
