CREATE OR REPLACE PROCEDURE entity.crud_entityinstance_delete(
  IN create_entityinstanceownerentityuuid uuid, IN create_entityinstanceentityuuid uuid, IN create_modifiedbyid bigint
)
 LANGUAGE plpgsql
AS $procedure$
Declare
...
-- tests needed
	-- no owner isNull
		call entity.crud_entityinstance_delete(
			...
			'47ee510b-e5ca-4df0-b876-5672b4accbd3', -- IN create_entityinstanceentityuuid uuid,	
			337)
	...
	-- owner and field combo do not exist
		call entity.crud_entityinstance_delete(
			...
			'3c04bedf-bcd8-40de-ae35-3a650146f7d7', -- IN create_entityinstanceentityuuid uuid,	
			337)		
