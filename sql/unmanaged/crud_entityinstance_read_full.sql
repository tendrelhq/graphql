...
if allcustomers = true and read_allentityinstances = true 
	...
	return query 
		...
		from (SELECT 
			...
			ltsystem.languagetranslationvalue,
		...
		from entity.entityinstance ei
			...
			join public.languagetranslations ltowner
			...
			join public.languagetranslations ltparent
			...
			join public.languagetranslations ltcorner
			...
			join public.languagetranslations lttemplate
			...
			join public.languagetranslations ltname
